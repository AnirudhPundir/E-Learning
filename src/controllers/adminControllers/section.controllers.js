...
const fetchAllSections = asyncHandler(async(req, res) => {
...
const fetchSectionContent = asyncHandler(async(req, res) => {});

export {addSection, updateSection, deleteSection, fetchAllSections};
